...
namespace ConvNet.Activations
{
    ...
    public class Logistic : IActivation
    {
        ...
        public string Type() { return "Logistic"; }
    }
    /// <summary>
    /// f(x) = tanh(x)
    /// </summary>
    ...
    /// f(x) = max(x,0)
    /// </summary>
    public class Leaky : IActivation
    {
        public double f(double x) { return x > 0 ? x : x * 0.01; }
        public double df(double x) { return x > 0 ? 1.0 : 0.01; }
        public string Type() { return "Leaky"; }
    }
}
